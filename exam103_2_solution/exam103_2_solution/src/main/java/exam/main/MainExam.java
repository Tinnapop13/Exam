...
//        exam04Lambda(); // 20 points
    ...
    private static void exam05Stream() {
        ...
        Predicate<String> endwith = s -> s.endsWith("e");
        Predicate<ToBeLambda> eval = o -> o.evalFirstname(endwith);
        Arrays.stream(lds).filter(eval).forEach(System.out::println);
        
//        System.out.println("exam05.2 ----------");
//        Arrays.stream(lds)
//                .filter(o -> o.getFirstname().endsWith("e"))
